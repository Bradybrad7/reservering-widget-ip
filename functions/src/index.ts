 ...
 */
export const handleReservationAction = functions
  .region("europe-west1")
  .runWith({ memory: "256MB" })
  .https.onRequest((req, res) => {
    return corsHandler(req, res, async (): Promise<void> => {
        try {
        ...
        const reservationRef = db.collection('reservations').doc(id as string);
          ...
          <body>
            <div class="success-container">
              ...
              <div class="reservation-info">
                ...
                <p><strong>Bedrijf:</strong> ${reservation?.companyName || 'Onbekend'}</p>
                <p><strong>Contact:</strong> ${reservation?.contactPerson || 'Onbekend'}</p>
