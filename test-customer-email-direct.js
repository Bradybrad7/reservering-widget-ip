// Test direct customer email naar jouw inbox
async function testCurrentCustomerEmail() {
  console.log('🧪 Testing current customer email template...');
  ...
  try {
    console.log('📧 Sending test customer email to your inbox...');
    ...
    const response = await fetch('https://europe-west1-dinner-theater-booking.cloudfunctions.net/sendSmtpEmail', {
      ...
      body: JSON.stringify({
        ...
        subject: 'TEST: Reserveringsaanvraag ontvangen - zondag 15 december 2025',
        html: `
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body style="margin: 0; padding: 0; background-color: #f5f5f5; font-family: Arial, sans-serif;">
        ...
        `,
        text: `TEST CUSTOMER EMAIL - Dit is de mooie versie!
...
✅ DEZE EMAIL HEEFT:
- Logo in header
- "Binnen 2 werkdagen antwoord" melding  
- Compacte card-based details
- Professional styling
- Proces uitleg

Als je deze email NIET ontvangt of een lelijke krijgt, dan is er een probleem!
...
Team Inspiration Point`
    ...
    console.log('✅ Test customer email sent!');
    console.log('\n🔍 Check your inbox for:');
    console.log('📧 Subject: "TEST: Reserveringsaanvraag ontvangen - zondag 15 december 2025"');
    console.log('\n✨ This email should have:');
    console.log('- 🏷️ Inspiration Point logo in header');
    console.log('- 📅 "Binnen 2 werkdagen antwoord" blue box');
    console.log('- 🎨 Card-based compact details layout');
    console.log('- 💼 Professional styling throughout');
    console.log('- 📝 5-step process explanation');
    
    console.log('\n❓ If you still received an ugly email:');
    console.log('1. Check if you looked at the ADMIN email (simple table)');
    console.log('2. Check spam folder');
    console.log('3. The template generation might have an error');
