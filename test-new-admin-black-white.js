// TEST: Nieuwe zwart/wit admin email met merchandise bij opmerkingen
const sendNewAdminEmail = async () => {
  console.log('📧 VERSTUREN NIEUWE ADMIN EMAIL (Zwart/Wit)');
  console.log('============================================\n');
            ...
            <div style="background-color: #fafafa; border: 1px solid #e0e0e0; border-radius: 4px; padding: 20px; margin-bottom: 20px;">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 6px 0;">Dhr Jan de Vries</td>
                    </tr>
                    <tr>
...
9999ZZ Factuurstad</div>
            ...
            <div style="background-color: #f9f9f9; border: 1px solid #e0e0e0; border-radius: 4px; padding: 15px; margin-bottom: 20px;">
                <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 4px 0; text-align: right; font-family: monospace; color: #333;">TEST-ADMIN-ZWART-WIT-001</td>
                    </tr>
                </table>
            </div>
  ...
  console.log('✅ NIEUWE ADMIN EMAIL VERSTUURD!\n');
  console.log('📋 WIJZIGINGEN:');
  console.log('   ✅ Zwart/wit opmaak (geen theatrale kleuren meer)');
  console.log('   ✅ Merchandise verplaatst naar opmerkingen sectie');
  console.log('   ✅ Dieetwensen bij opmerkingen');
  console.log('   ✅ Factuuradres bij opmerkingen als afwijkend');
  console.log('   ✅ Klant opmerkingen bovenaan in opmerkingen sectie');
  console.log('   ✅ Duidelijke layout met scheidingslijnen');
  console.log('\n📬 Check je inbox: info@inspiration-point.nl');
};

sendNewAdminEmail().catch(console.error);
